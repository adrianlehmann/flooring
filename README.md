...
Marketing site for a flooring contractor, built with React and Vite.
...
This repo is set up for a **static** Cloudflare Pages deploy of the site in `artifacts/flooring-website`.
...
| **Build output directory** | `artifacts/flooring-website/dist/public` |
...
| Path | Purpose |
|------|---------|
| `artifacts/flooring-website` | **Production static site** (deploy this) |
